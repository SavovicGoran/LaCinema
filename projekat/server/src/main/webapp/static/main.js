...
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./edit/edit.component */ "./src/app/edit/edit.component.ts");
/* harmony import */ var _filmovi_filmovi_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./filmovi/filmovi.component */ "./src/app/filmovi/filmovi.component.ts");
/* harmony import */ var _dodaj_dodaj_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./dodaj/dodaj.component */ "./src/app/dodaj/dodaj.component.ts");
/* harmony import */ var _security_can_activate_admin_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./security/can-activate-admin.service */ "./src/app/security/can-activate-admin.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'filmovi/:id', component: _filmovi_filmovi_component__WEBPACK_IMPORTED_MODULE_14__["FilmoviComponent"] },
    { path: 'main', component: _main_component_main_component_component__WEBPACK_IMPORTED_MODULE_6__["MainComponentComponent"] },
    { path: 'edit', component: _edit_edit_component__WEBPACK_IMPORTED_MODULE_13__["EditComponent"], canActivate: [_security_can_activate_admin_service__WEBPACK_IMPORTED_MODULE_16__["CanActivateAdminService"]] },
    { path: 'dodaj', component: _dodaj_dodaj_component__WEBPACK_IMPORTED_MODULE_15__["DodajComponent"], canActivate: [_security_can_activate_admin_service__WEBPACK_IMPORTED_MODULE_16__["CanActivateAdminService"]] },
    { path: 'dodaj/:id', component: _dodaj_dodaj_component__WEBPACK_IMPORTED_MODULE_15__["DodajComponent"], canActivate: [_security_can_activate_admin_service__WEBPACK_IMPORTED_MODULE_16__["CanActivateAdminService"]] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _filmovi_filmovi_component__WEBPACK_IMPORTED_MODULE_14__["FilmoviComponent"],
                _dodaj_dodaj_component__WEBPACK_IMPORTED_MODULE_15__["DodajComponent"]
            ],
            imports: [
...
/***/ "./src/app/dodaj/dodaj.component.css":
/*!*******************************************!*\
  !*** ./src/app/dodaj/dodaj.component.css ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/app/dodaj/dodaj.component.html":
/*!********************************************!*\
  !*** ./src/app/dodaj/dodaj.component.html ***!
  \********************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row\">\n    <div class=\"col-md-12\">\n    <form class=\"form\" (ngSubmit)=\"save()\">\n    <div class=\"form-group\">\n    Naslov:<input name=\"naslov\" class=\"form-control\" [(ngModel)]=\"film.naslov\">\n    </div>\n    <div class=\"form-group\">\n    Radnja:<input name=\"radnja\" class=\"form-control\" [(ngModel)]=\"film.radnja\">\n    </div>\n    <div class=\"form-group\">\n    Zanr:\n    <select class=\"form-control\" name=\"zanr\" [compareWith]=\"byId\" [(ngModel)]=\"film.zanr\">\n    <option *ngFor=\"let zanr of zanrovi\" [ngValue]=\"zanr\">{{zanr?.naziv}}</option>\n    </select>\n    </div>\n    \n    <input type=\"submit\" value=\"Sacuvaj\" class=\"btn btn-default\"> &nbsp;\n    <button class=\"btn btn-default\" (click)=\"reset()\">Ponisti</button>\n    </form>\n    \n    </div>\n    </div>"
...
var DodajComponent = /** @class */ (function () {
    function DodajComponent(authenticationService, http) {
        this.authenticationService = authenticationService;
        this.http = http;
        this.film = {
            naslov: '',
    ...
    DodajComponent.prototype.loadData = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set('page', this.currentPage.toString())
            .set('size', '5');
        this.http.get('api/filmovi', { params: params }).subscribe(function (data) {
            // this.http.get(`api/computer-parts?page=${this.currentPage}&size=${5}`).subscribe( data => {
            _this.filmovi = data['content'];
            _this.numberOfPages = data['totalPages'];
            _this.reset();
        });
    };
    DodajComponent.prototype.filter = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
    ...
    DodajComponent.prototype.loadZanr = function () {
        var _this = this;
        this.http.get('api/zanrovi').subscribe(function (data) {
            _this.zanrovi = data;
        });
    };
    DodajComponent.prototype.reset = function () {
        this.film = {
            naslov: '',
            radnja: '',
            zanr: ''
    ...
    DodajComponent.prototype.save = function () {
        var _this = this;
        ...
        if (this.film.id === undefined) {
            this.http.post('api/filmovi', JSON.stringify(this.film), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
        else {
            this.http.put("api/filmovi/" + this.film.id, JSON.stringify(this.film), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
    };
    DodajComponent.prototype.delete = function (f) {
        var _this = this;
        this.http.delete("api/filmovi/" + f.id).subscribe(function (data) {
            console.log(data);
            _this.loadData();
        });
    };
    DodajComponent.prototype.changePage = function (x) {
        if (this.currentPage + x >= 0 && this.currentPage + x < this.numberOfPages) {
            this.currentPage += x;
            this.loadData();
        }
    };
    DodajComponent.prototype.byId = function (item1, item2) {
        if (!item1 || !item2) {
            return false;
        }
    ...
    DodajComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-dodaj',
            template: __webpack_require__(/*! ./dodaj.component.html */ "./src/app/dodaj/dodaj.component.html"),
            styles: [__webpack_require__(/*! ./dodaj.component.css */ "./src/app/dodaj/dodaj.component.css")]
        }),
        __metadata("design:paramtypes", [_security_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], DodajComponent);
...
var EditComponent = /** @class */ (function () {
    function EditComponent(authenticationService, http) {
        this.authenticationService = authenticationService;
        this.http = http;
        this.film = {
            naslov: '',
    ...
    EditComponent.prototype.loadData = function () {
        var _this = this;
    ...
    EditComponent.prototype.filter = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('title', this.title)
            .set('genre', this.genre);
    ...
    EditComponent.prototype.loadZanr = function () {
        var _this = this;
        this.http.get('api/zanrovi').subscribe(function (data) {
            _this.zanrovi = data;
        });
    ...
    EditComponent.prototype.edit = function (f) {
        this.film = f;
    };
    EditComponent.prototype.delete = function (f) {
        var _this = this;
        this.http.delete("api/filmovi/" + f.id).subscribe(function (data) {
            console.log(data);
            _this.loadData();
    ...
    EditComponent.prototype.changePage = function (x) {
        if (this.currentPage + x >= 0 && this.currentPage + x < this.numberOfPages) {
            this.currentPage += x;
            this.loadData();
        }
    ...
    EditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_security_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], EditComponent);
...
/***/ "./src/app/filmovi/filmovi.component.css":
/*!***********************************************!*\
  !*** ./src/app/filmovi/filmovi.component.css ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2ZpbG1vdmkvZmlsbW92aS5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/filmovi/filmovi.component.html":
/*!************************************************!*\
  !*** ./src/app/filmovi/filmovi.component.html ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "<div>\n  <h3>{{film.naslov}}  ( {{film.zanr.naziv}} )</h3>\n  <br/>\n  <br/>\n  <br/>\n  <h3>Projekcije</h3>\n  <ul>\n      <li *ngFor=\"let projekcija of film.projekcije\">{{projekcija.datum}} {{projekcija.vreme}}</li>\n      </ul>\n</div>\n\n"

/***/ }),

/***/ "./src/app/filmovi/filmovi.component.ts":
/*!**********************************************!*\
  !*** ./src/app/filmovi/filmovi.component.ts ***!
  \**********************************************/
/*! exports provided: FilmoviComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilmoviComponent", function() { return FilmoviComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FilmoviComponent = /** @class */ (function () {
    function FilmoviComponent(route, http) {
        var _this = this;
        this.route = route;
        this.http = http;
        this.film = {
        ...
        this.route.params.subscribe(function (params) {
            var id = params['id'];
            _this.http.get("api/filmovi/" + id).subscribe(function (response) {
                _this.film = response;
            });
        });
    }
    FilmoviComponent.prototype.ngOnInit = function () {
    };
    FilmoviComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-filmovi',
            template: __webpack_require__(/*! ./filmovi.component.html */ "./src/app/filmovi/filmovi.component.html"),
            styles: [__webpack_require__(/*! ./filmovi.component.css */ "./src/app/filmovi/filmovi.component.css")]
        }),
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authenticationService.login(this.user.username, this.user.password).subscribe(function (loggedIn) {
            if (_this.authenticationService.hasRole('ROLE_ADMIN')) {
...
module.exports = "\r\n<div class=\"row\">\r\n        <div class=\"col-md-10\">\r\n                <form class=\"form-inline\" (ngSubmit)=\"filter()\">\r\n                <div class=\"form-inline\">\r\n                Kategorija:\r\n                <select class=\"form-control\" name=\"genre\" [(ngModel)]=\"genre\">\r\n                <option *ngFor=\"let zanr of zanrovi\" ngValue=\"{{zanr?.naziv}}\">{{zanr?.naziv}}</option>\r\n                </select>\r\n                Naslov:<input name=\"title\" class=\"form-control\" [(ngModel)]=\"title\">\r\n                <input type=\"submit\" value=\"filter\" class=\"btn btn-default\">\r\n                </div>\r\n                </form>\r\n                </div>\r\n                <br/>\r\n                <br/>\r\n        <div class=\"pull-right\">\r\n                <div class=\"btn-group\">\r\n                    <button class=\"btn btn-default\" [disabled]=\"currentPage<1\" (click)=\"changePage(-1)\"><</button>\r\n                    <button class=\"btn btn-default\" [disabled]=\"currentPage>numberOfPages-2\" (click)=\"changePage(1)\">></button>\r\n                </div>\r\n            </div>\r\n    <div class=\"col-md-12\">\r\n        <table class=\"table table-striped\">\r\n        <tr>\r\n            <th>naslov</th>\r\n            <th>radnja</th>\r\n            <th>zanr</th>\r\n        </tr>\r\n    <tr *ngFor=\"let f of filmovi\">\r\n        <td>{{f.naslov}}</td>\r\n        <td>{{f.radnja}}\r\n            <a class=\"btn btn-primary\" href=\"filmovi/{{f.id}}\">Projekcije</a>\r\n        </td>\r\n        <td>{{f.zanr.naziv}}</td>\r\n    </tr>\r\n    </table>\r\n    </div>\r\n</div>\r\n\r\n\r\n"
...
var MainComponentComponent = /** @class */ (function () {
    ...
    MainComponentComponent.prototype.loadZanr = function () {
        var _this = this;
        this.http.get('api/zanrovi').subscribe(function (data) {
            _this.zanrovi = data;
        });
    };
    MainComponentComponent.prototype.filter = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set('title', this.title)
            .set('genre', this.genre);
    ...
    MainComponentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_security_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
...
/***/ "./src/app/security/can-activate-admin.service.ts":
/*!********************************************************!*\
  !*** ./src/app/security/can-activate-admin.service.ts ***!
  \********************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./authentication.service */ "./src/app/security/authentication.service.ts");
...
var CanActivateAdminService = /** @class */ (function () {
    function CanActivateAdminService(authenticationService, router) {
        this.authenticationService = authenticationService;
        this.router = router;
    }
    CanActivateAdminService.prototype.canActivate = function (next, state) {
    ...
    CanActivateAdminService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
    ...
    return CanActivateAdminService;
}());
...
module.exports = __webpack_require__(/*! C:\Users\student\Desktop\STARTER\projekat\client\src\main.ts */"./src/main.ts");
